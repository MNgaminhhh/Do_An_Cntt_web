    ...
    return (
        <div className={classes.container}>
            <div className={classes.wrapper}>
                ...
                {accountDeleted && <p className={classes.successMessage}>Tài khoản đã được xóa thành công</p>}
                <form className={classes.form} onSubmit={handleSubmit}>
                    <div className={classes.fullname}>
                        <label className={classes.label_form} htmlFor="full_name">Họ và Tên:</label>
                        <input
                    ...
                    {!admin.isChangingPassword ? (
                        <button className={classes.button_effect} type="button" onClick={handlePasswordChange}>
                            Đổi mật khẩu
                        </button>
                    ) : (
                        <div className={classes.password}>
                            <label className={classes.label_form} htmlFor="password">Mật khẩu mới:</label>
                            <input
                                className={classes.input_form}
                                ...
                                onChange={handleInputChange}
                            />
                            <button className={classes.button_effect} type="button" onClick={togglePasswordVisibility}>
                                {admin.isPasswordVisible ? "Ẩn mật khẩu" : "Hiện mật khẩu"}
                            </button>
                            <button className={classes.button_effect} onClick={handleDeleteAccount}>
                                Xóa Tài Khoản
                            </button>
                            <button className={classes.button_effect} type="submit">Lưu</button>
                        </div>
                    )}
                </form>
            </div>
